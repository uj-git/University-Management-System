...
public class UpdateTeacher extends JFrame implements ActionListener {
    ...
    UpdateTeacher(){
        ...
        JLabel lblrollnumber = new JLabel("Select Emplyee Id");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource()== submit){
            ...
            try{
                String query = "update teacher set address='"+address+"', phone='"+phone+"', email='"+email+"', education='"+course+"', department='"+branch+"' where empdId='"+empId+"'";
